...
# ROW 1, COLUMN 1
with(power, plot(fulltime, Global_active_power, type = "n", ylab="Global Active Power",
                 xlab=""))
lines(power2$fulltime, power2$Global_active_power)

# ROW 1, COLUMN 2
with(power, plot(fulltime, Voltage, type = "n", ylab="Voltage",
                 xlab="datetime"))
lines(power2$fulltime, power2$Voltage)
...
# ROW 2, COLUMN 2
with(power, plot(fulltime, Global_reactive_power, type = "n", ylab="Global_reactive_power",
                 xlab="datetime"))
lines(power2$fulltime, power2$Global_reactive_power)
